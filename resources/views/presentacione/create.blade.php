...
@section('title', 'Crear Presentacione')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="col-md-8">
                <h1 class="h3 mb-0 text-gray-800">Crear Presentacion</h1>
                    ...
                    <div class="card-body">
                        <form action="{{ route('presentaciones.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('presentaciones.index') }}" class="btn btn-secondary me-2">Cancelar</a>
