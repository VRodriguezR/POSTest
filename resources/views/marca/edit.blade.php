                        ...
                        <form action="{{ route('marcas.update', ['marca'=> $marca]) }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3">{{ old('descripcion', $marca->caracteristica->descripcion)}}</textarea>
                                    @error('descripcion')
                                        <span class="text-danger fs-7">{{ '*'.$message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    <a href="{{ route('marcas.index') }}" class="btn btn-secondary ms-auto">Cancelar</a>
